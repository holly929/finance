...
export const PERMISSION_PAGES = [
  'dashboard', 'properties', 'billing', 'bop', 'bop-billing', 'bills', 'reports', 'users', 'settings', 'integrations'
] as const;
...
const defaultPermissions: RolePermissions = {
  Admin: {
    dashboard: true, properties: true, billing: true, bop: true, 'bop-billing': true, bills: true, reports: true,
  ...
  Viewer: {
    dashboard: true, properties: false, billing: false, bop: false, 'bop-billing': false, bills: false, reports: false,
